...
```shell
yarn add contentlayer next-contentlayer rehype-pretty-code remark-gfm shiki @tailwindcss/typography --dev
```
...
매번 입력하기 귀찮으니 스니펫 설정 해놓는 걸 추천합니다.
...
게시글 페이지에서 allPosts를 import해서 url과 일치하는 포스트를 필터링해서 사용한다.
